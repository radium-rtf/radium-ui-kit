...
const smallIcons: Record<SmallIcon, ReactNode> = {
  blank: null,
  'chevron-up': <path d='M11.5 8.5L6 3L0.5 8.5' className={c.svg} strokeLinecap='round' strokeLinejoin='round' />,
  'chevron-right': <path d='M3.5 0.5L9 6L3.5 11.5' className={c.svg} strokeLinecap='round' strokeLinejoin='round' />,
  'chevron-down': <path d='M11.5 3.5L6 9L0.5 3.5' className={c.svg} strokeLinecap='round' strokeLinejoin='round' />,
  'chevron-left': <path d='M8.5 11.5L3 6L8.5 0.5' className={c.svg} strokeLinecap='round' strokeLinejoin='round' />,
  remove: (
    <path d='M0.5 0.5L11.5 11.5M11.5 0.5L0.5 11.5' className={c.svg} strokeLinecap='round' strokeLinejoin='round' />
  ),
  handle: (
    <g>
      <path
  ...
  'arrow-down': (
    <path d='M10.5 6.5L5.5 11.5M5.5 11.5L0.5 6.5M5.5 11.5L5.5 0.5' strokeLinecap='round' strokeLinejoin='round' />
  ),
  'arrow-up': (
    <path
  ...
  add: (
    <>
      <path d='M0.5 5.5H10.5' className={c.svg} strokeLinecap='round' />
      <path d='M5.5 10.5L5.5 0.5' className={c.svg} strokeLinecap='round' />
    </>
  ),
  'external-link': (
    <path
  ...
  done: <path d='M0.5 7.5L3.5 10.5L11.5 2.5' className={c.svg} strokeLinecap='round' strokeLinejoin='round' />,
  visible: (
    <>
      <path
  ...
  keyword: (
    <>
      <rect x='0.5' y='4.5' width='11' height='3' rx='1.5' className={c.svg} />
      <rect x='2.25' y='1.25' width='7.5' height='0.5' rx='0.25' className={c.svg} strokeWidth='0.5' />
      <rect x='2.25' y='10.25' width='7.5' height='0.5' rx='0.25' className={c.svg} strokeWidth='0.5' />
    </>
  ),
  timer: (
    <>
      <circle cx='6' cy='6' r='5.5' className={c.svg} />
      <path d='M5 4V7H8' className={c.svg} strokeLinecap='round' strokeLinejoin='round' />
    </>
  ),
}
